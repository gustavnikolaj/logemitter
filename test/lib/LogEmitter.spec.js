...
describe('lib/LogEmitter', function () {
    ...
    describe('baseLogObject', function () {
        it('should add basic properties to the emitted object', function () {
            var logEmitter = new LogEmitter();
            logEmitter.on('log', function (e) {
                expect(e, 'to satisfy', {
                    type: 'log',
        ...
        it('should be able to extend the baseLogObject', function () {
            var logEmitter = new LogEmitter();
            logEmitter.on('log', function (e) {
                expect(e, 'to satisfy', {
                    message: 'a log message',
        ...
        it('should keep the defaults when adding extra attributes', function () {
            var logEmitter = new LogEmitter();
            logEmitter.on('log', function (e) {
                expect(e, 'to satisfy', {
                    type: 'log',
