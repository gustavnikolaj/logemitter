...
LogEmitter.prototype.log = function (arg1) {
    if (arguments.length === 1 && arg1 && typeof arg1 === 'object') {
        this.emit('log', extend({ severity: 'log' }, arg1));
    } else {
        this.emit('log', {
            severity: 'log',
...
LogEmitter.prototype.info = function (arg1) {
    if (arguments.length === 1 && arg1 && typeof arg1 === 'object') {
        this.emit('log', extend({ severity: 'info' }, arg1));
    } else {
        this.emit('log', {
            severity: 'info',
            message: Array.prototype.slice.call(arguments).join(', ')
...
LogEmitter.prototype.debug = function (arg1) {
    if (arguments.length === 1 && arg1 && typeof arg1 === 'object') {
        this.emit('log', extend({ severity: 'debug' }, arg1));
    } else {
        this.emit('log', {
            severity: 'debug',
            message: Array.prototype.slice.call(arguments).join(', ')
...
LogEmitter.prototype.error = function (arg1) {
    if (arguments.length === 1 && arg1 && typeof arg1 === 'object') {
        this.emit('log', extend({ severity: 'error' }, arg1));
    } else {
        this.emit('log', {
            severity: 'error',
            message: Array.prototype.slice.call(arguments).join(', ')
